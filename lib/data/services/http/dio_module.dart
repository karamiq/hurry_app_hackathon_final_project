      ...
      InterceptorsWrapper(
        onError: (e, handler) async {
          ...
          switch (e.type) {
            case DioExceptionType.badCertificate:
              Utils.showErrorOverlay("حدث خطأ ما");
              break;
            case DioExceptionType.badResponse:
              ...
              Utils.showErrorOverlay(message);
              break;
            ...
            case DioExceptionType.sendTimeout:
              Utils.showErrorOverlay("حدث خطأ في الاتصال");
              break;
        ...
        onResponse: (response, handler) {
          ...
          // }
            ...
            data = {"data": {}, "message": response.data, "statusCode": response.statusCode};
          }
