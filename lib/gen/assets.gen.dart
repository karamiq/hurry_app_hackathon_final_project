...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/UploadSimple.svg
  SvgGenImage get uploadSimple =>
      const SvgGenImage('assets/svg/UploadSimple.svg');

  /// File path: assets/svg/arabic.svg
  SvgGenImage get arabic => const SvgGenImage('assets/svg/arabic.svg');
  ...
  List<SvgGenImage> get values =>
      [cameraPlus, uploadSimple, arabic, cancel, english, search01];
}
